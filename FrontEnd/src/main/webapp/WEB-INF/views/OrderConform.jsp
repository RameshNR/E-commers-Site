...
<table id="tab" align="center" class="table table-bordered">
	...
	<form action="<c:url value="/updateAddress"/>" method="post">
		...
		<td colspan="0"  align="center">
			<textarea class = "form-control" cols="40" rows="3" name="addr" placeholder="Enter the New Address"></textarea>
		</td>
		
		<td colspan="2">
			<b  id="c_addr_title">Current Address</b>
		...
		<td colspan="1"  align="center">
			<input type="submit" class="btn btn-dark" value="Update Address" />
		</td>
	</form>
	</tr>
	
	<tr bgcolor="#3c454e">
		<td colspan="4"><a href="<c:url value="/showCart"/>" class="btn btn-light">Edit CartItem</a> </td>
		<td colspan="2" align="center"><a href="<c:url value="/payment"/>" class="btn btn-success">Payment</a> </td>
	</tr>
